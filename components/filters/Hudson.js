...
const Hudson = ({ children: t }) =>
  (<Node
    shader={shaders.Hudson}
    uniforms={{
      inputImageTexture: t,
      inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/hudsonBackground.png')),
      inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/overlayMap.png')),
      inputImageTexture4: resolveAssetSource(require('../../assets/images/insta/hudsonMap.png'))
    }}
  />);
