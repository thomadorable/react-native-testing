...
const Sierra = ({ children: t }) =>
  (<Node
    ...
    uniforms={{
      inputImageTexture: t,
      inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/sierraVignette.png')),
      inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/overlayMap.png')),
      inputImageTexture4: resolveAssetSource(require('../../assets/images/insta/sierraMap.png'))
    }}
  />);
