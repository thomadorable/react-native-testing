...
export default class Earlybird extends React.PureComponent<{ on: boolean, children: React.Node }> {
  render() {
      ...
      return (
          <Node
              ...
              uniforms={{
                  ...
                  inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/earlyBirdCurves.png')),
                  inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/earlybirdOverlayMap.png')),
                  inputImageTexture4: resolveAssetSource(require('../../assets/images/insta/vignetteMap.png')),
                  inputImageTexture5: resolveAssetSource(require('../../assets/images/insta/earlybirdBlowout.png')),
                  inputImageTexture6: resolveAssetSource(require('../../assets/images/insta/earlybirdMap.png'))
              }}
          />
      );
  }
