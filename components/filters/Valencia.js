...
const Valencia = ({ children: t }) =>
  (<Node
    ...
    uniforms={{
      inputImageTexture: t,
      inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/valenciaMap.png')),
      inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/valenciaGradientMap.png'))
    }}
  />);
