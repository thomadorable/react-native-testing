...
const Sutro = ({ children: t }) =>
  (<Node
    ...
    uniforms={{
      inputImageTexture: t,
      inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/vignetteMap.png')),
      inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/sutroMetal.png')),
      inputImageTexture4: resolveAssetSource(require('../../assets/images/insta/softLight.png')),
      inputImageTexture5: resolveAssetSource(require('../../assets/images/insta/sutroEdgeBurn.png')),
      inputImageTexture6: resolveAssetSource(require('../../assets/images/insta/sutroCurves.png'))
    }}
  />);
