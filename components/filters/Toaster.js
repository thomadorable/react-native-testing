...
const Toaster = ({ children: t }) =>
  (<Node
    ...
    uniforms={{
      inputImageTexture: t,
      inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/toasterMetal.png')),
      inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/toasterSoftLight.png')),
      inputImageTexture4: resolveAssetSource(require('../../assets/images/insta/toasterCurves.png')),
      inputImageTexture5: resolveAssetSource(require('../../assets/images/insta/toasterOverlayMapWarm.png')),
      inputImageTexture6: resolveAssetSource(require('../../assets/images/insta/toasterColorShift.png'))
    }}
  />);
