...
const Hefe = ({ children: t }) =>
  (<Node
    ...
    uniforms={{
      inputImageTexture: t,
      inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/edgeBurn.png')),
      inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/hefeMap.png')),
      inputImageTexture4: resolveAssetSource(require('../../assets/images/insta/hefeGradientMap.png')),
      inputImageTexture5: resolveAssetSource(require('../../assets/images/insta/hefeSoftLight.png')),
      inputImageTexture6: resolveAssetSource(require('../../assets/images/insta/hefeMetal.png'))
    }}
  />);
