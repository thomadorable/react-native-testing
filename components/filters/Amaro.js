...
export default class Amaro extends React.PureComponent<{ on: boolean, children: React.Node }> {
    render() {
        ...
        return (
            <Node
                ...
                uniforms={{
                    ...
                    inputImageTexture2: resolveAssetSource(require('../../assets/images/insta/blackboard1024.png')),
                    inputImageTexture3: resolveAssetSource(require('../../assets/images/insta/overlayMap.png')),
                    inputImageTexture4: resolveAssetSource(require('../../assets/images/insta/amaroMap.png'))
                }}
            />
        );
    }
